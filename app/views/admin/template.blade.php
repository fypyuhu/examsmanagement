                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                        {{Form::open(array('route' => 'session.destroy', 'method'=>'DELETE'))}}
            ...
            <li class="treeview">
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('user.index')}}"><i class="fa fa-circle-o"></i> View All</a></li>
                <li><a href="{{route('user.create')}}"><i class="fa fa-circle-o"></i> Add</a></li>
              </ul>
            </li>
             <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                   <li><a href="{{route('category.index')}}"><i class="fa fa-circle-o"></i> View All Category</a></li>
                 <li><a href="{{route('category.create')}}"><i class="fa fa-circle-o"></i> Add new Category</a></li>
                
                 <li><a href="{{route('question.index')}}"><i class="fa fa-circle-o"></i> View All Questions</a></li>
                 <li><a href="{{route('question.create')}}"><i class="fa fa-circle-o"></i> Add new Question</a></li>
     ...
     <div class="content-wrapper">
         <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">@yield('purpose')</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
