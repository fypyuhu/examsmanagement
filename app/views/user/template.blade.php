...
<html>
  ...
  <link rel="stylesheet" href="{{URL::to('/')}}/assets/plugins/colorpicker/bootstrap-colorpicker.min.css">
...
<!-- bootstrap color picker -->
<script src="{{URL::to('/')}}/assets/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
